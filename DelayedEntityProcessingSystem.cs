...
namespace Artemis
{
	public abstract class DelayedEntityProcessingSystem : DelayedEntitySystem {
		 ...
		 */
		public DelayedEntityProcessingSystem(Component requiredType, params Component[] otherTypes) {
		...
		protected void processEntities(Bag<Entity> entities, int accumulatedDelta) {
